...
SWEP.Primary.ClipSize                   = 0                                     -- Size of a clip                                     -- Default number of bullets in a clip
...
function SWEP:Initialize()
	    ...
	    if not self.Owner:IsPolice() then
		...
		if CLIENT then
				local oldpath = "materials/vgui/hud/name" -- the path goes here
