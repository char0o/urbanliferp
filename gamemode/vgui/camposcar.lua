...
function PANEL:Init()
	...
	for k,v in pairs(VEHICLE_DB) do
		self.dlistview:AddLine(""..VEHICLE_DB[k].ID, ""..VEHICLE_DB[k].Name, ""..VEHICLE_DB[k].Model)
	end
	...
	self.dbuttonprint.DoClick = function() 
		...
		print("Lookat : Vector("..lookatx..", "..lookaty..", "..lookatz..")")
		print("Campos : Vector("..camposx..", "..camposy..", "..camposz..")")
		print("FOV:"..fov) 
	end
	reset = false
	defaultcoord = 0
	...
	self.dsliderfov:SetMinMax(-100, 200)
...
function PANEL:Paint()
	...
	surface.DrawRect(100, 70, 100, 100)
end
...
function PANEL:Think()
	...
	self.dmodel:SetModel(VEHICLE_DB[model].Model)
